...
def createUser():
    ...
    try:
        ...
        thong_tin["email"]=email
        thong_tin["operating time"]=0
        sql = f"INSERT INTO user VALUES ({result_id_like[0][0]+1}, %s , %s, %s , %s , %s ,0,%s)"
        val = ( link_avatar,dia_chi_ip,device_name_register , password, time_online,email)
